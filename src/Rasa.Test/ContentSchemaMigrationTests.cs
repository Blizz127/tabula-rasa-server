...
namespace Rasa.Test
{
    ...
    public class ContentSchemaMigrationTests
    {
        ...
        private const string BootcampS3Migration = "20260914120000_BootcampS3PerCharacterInstancing";
        ...
        public static void CreatePreviousWorld(SqliteWorldContext context, SqliteConnection connection)
        {
            ...
            CollectionAssert.AreEqual(
                new[] { ContentLayerMigration, BootcampS1Migration, ObjectiveColumnsMigration, ObjectiveSkeletonMigration, BootcampS2Migration, BootcampFixNpcAppearanceMigration, BootcampS3Migration },
        ...
        public void WorldUpgradeAddsEmptyContentTablesAndRollbackKeepsExistingRows()
        {
            ...
            CollectionAssert.AreEqual(
                new[] { BootcampS1Migration, ObjectiveColumnsMigration, ObjectiveSkeletonMigration, BootcampS2Migration, BootcampFixNpcAppearanceMigration, BootcampS3Migration },
                context.Database.GetPendingMigrations().ToArray());
            foreach (var table in WorldTables)
            {
