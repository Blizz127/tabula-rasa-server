...
namespace Rasa.Test
{
    ...
    public class ContentSchemaMigrationTests
    {
        ...
        public void BootcampS1SeedsTheInitiationRowsAndRollsBackToEmptyContentTables()
        {
            ...
            Assert.AreEqual(0L, Scalar(connection, "SELECT COUNT(*) FROM creature a JOIN creature b ON a.name_id = b.name_id AND a.id < b.id WHERE a.name_id <> 0 AND a.id BETWEEN 198500 AND 199999 AND b.id BETWEEN 510001 AND 510999"));
            ...
            Assert.AreEqual(1L, Scalar(connection, "SELECT COUNT(*) FROM content_placement WHERE id = 199107 AND pos_y = 140.442 AND pos_x = -122.2 AND pos_z = 128.2"));
            ...
            Assert.AreEqual(5L, MissionsInvolving(connection, 199200, 199205));
