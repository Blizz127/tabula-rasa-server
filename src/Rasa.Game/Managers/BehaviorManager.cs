...
namespace Rasa.Managers
{
    ...
    public class BehaviorManager
    {
        ...
        public const byte BehaviorActionFollow = 5;   // a minion trailing its master, or holding an anchor (InfiniteRasa 492954a)
        ...
        {
            // A passive minion does not fight, and this is the one place worth saying so: it covers both the aggro
            // scan and being shot at (MissileManager calls straight in here), so there is no second path where
            // passive quietly stops meaning passive. (InfiniteRasa 492954a)
        ...
        /// <summary>
        /// Trails an entity - normally the minion's master, or another player after a Follow Target order. Clears
        /// any anchor, which is what Follow Me is for. (InfiniteRasa 492954a)
        /// </summary>
        ...
        /// <summary>
        /// Plants the minion at a spot and leaves it there: Go sets the picked location, Stay the minion's own. It
        /// may still leave to act, and returns here when it is done. (InfiniteRasa 492954a)
        /// </summary>
        ...
        /// <summary>
        /// Whether this creature goes looking for a fight. An ordinary creature always does; a minion does only when
        /// its master has set it Aggressive. Defensive still fights back, because retaliation comes through
        /// SetActionFighting rather than through a scan. (InfiniteRasa 492954a)
        /// </summary>
