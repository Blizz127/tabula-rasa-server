        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ordinal = table.Column<uint>(type: "int unsigned", nullable: false),
                    is_required = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    revealed_on_accept = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    mission_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    completed_objective_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    revealed_objective_id = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
