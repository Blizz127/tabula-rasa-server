        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    half_height = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    condition_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    or_group = table.Column<byte>(type: "INTEGER", nullable: false),
                    term_index = table.Column<byte>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    item_set_id = table.Column<uint>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    map_context_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    instancing = table.Column<byte>(type: "INTEGER", nullable: false),
                    comment = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entity_class_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    usable_kind = table.Column<byte>(type: "INTEGER", nullable: false),
                    pos_x = table.Column<double>(type: "REAL", nullable: false),
                    pos_y = table.Column<double>(type: "REAL", nullable: false),
                    pos_z = table.Column<double>(type: "REAL", nullable: false),
                    rotation = table.Column<double>(type: "REAL", nullable: false),
                    behavior = table.Column<byte>(type: "INTEGER", nullable: false),
                    initial_state = table.Column<uint>(type: "INTEGER", nullable: false),
                    alternate_state = table.Column<uint>(type: "INTEGER", nullable: false),
                    alternate_state_condition_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    windup_ms = table.Column<uint>(type: "INTEGER", nullable: false),
                    name_override_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    hit_points = table.Column<uint>(type: "INTEGER", nullable: false),
                    restore_ms = table.Column<uint>(type: "INTEGER", nullable: false),
                    fuse_ms = table.Column<uint>(type: "INTEGER", nullable: false),
                    loot_item_set_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    respawn_ms = table.Column<uint>(type: "INTEGER", nullable: false),
                    present_condition_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    usable_condition_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    comment = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<uint>(type: "INTEGER", nullable: false),
                    map_context_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    @event = table.Column<byte>(name: "event", type: "INTEGER", nullable: false),
                    mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    objective_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    area_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    placement_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    state_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    condition_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    comment = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    rule_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    ...
                    npc_name_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    tutorial_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    logos_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    logos_protocol = table.Column<byte>(type: "INTEGER", nullable: false),
                    ...
                    state_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    fact_key = table.Column<string>(type: "varchar(64)", nullable: false),
                    fact_value = table.Column<int>(type: "INTEGER", nullable: false),
                    location_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    audio_set_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    comment = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    objective_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    binding_id = table.Column<byte>(type: "INTEGER", nullable: false),
                    kind = table.Column<byte>(type: "INTEGER", nullable: false),
                    area_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    placement_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    creature_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    action_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    destroying_hit_only = table.Column<bool>(type: "INTEGER", nullable: false),
                    equip_match = table.Column<byte>(type: "INTEGER", nullable: false),
                    item_template_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    item_set_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    target_state = table.Column<uint>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    objective_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    indicator_index = table.Column<byte>(type: "INTEGER", nullable: false),
                    indicator_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    pos_x = table.Column<double>(type: "REAL", nullable: false),
                    pos_y = table.Column<double>(type: "REAL", nullable: false),
                    pos_z = table.Column<double>(type: "REAL", nullable: false),
                    radius = table.Column<double>(type: "REAL", nullable: false),
                    show_3d = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    objective_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    limit_seconds = table.Column<uint>(type: "INTEGER", nullable: false),
                    on_expire = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    or_group = table.Column<byte>(type: "INTEGER", nullable: false),
                    required_mission_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    required_state = table.Column<byte>(type: "INTEGER", nullable: false),
                    comment = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
